...
dataset = datasets.load_dataset("thavens/simple_instructions", split="train")
dataset = dataset.shuffle(seed=42)
dataset = dataset.to_list()[:20]
...
CHECKPOINT_PATH = "dataset_v2/judged_responses.jsonl"
...
data_path = "dataset_v2/judged_responses"
